...
>
>6. Setelah mempelajari bab ini, saya semakin termotivasi untuk mencoba dan memahami lebih dalam penggunaan Ubuntu. Ada beberapa alasan mengapa saya sangat tertarik untuk mendalami sistem operasi ini.  
Pertama, saya menyadari bahwa Linux khususnya Ubuntu menjadi fondasi dari berbagai teknologi modern yang saat ini banyak digunakan di industri. Hampir semua server di dunia, layanan cloud computing, container dengan Docker, hingga infrastruktur DevOps berjalan di atas Linux. Dengan memahami Ubuntu secara mendalam, saya membuka peluang untuk berkarir di bidang yang sedang berkembang pesat seperti System Administrator, DevOps Engineer, atau Cloud Engineer.  
Kedua, dari latihan praktik yang telah saya lakukan selama perkuliahan, saya baru merasakan sedikit dari kemampuan Ubuntu. Saya ingin menggali lebih dalam tentang administrasi sistem, seperti manajemen pengguna dan hak akses, konfigurasi jaringan, pengelolaan service dengan systemd, hingga monitoring dan logging. Saya juga tertarik untuk belajar menginstall dan mengkonfigurasi berbagai layanan server seperti web server Apache atau Nginx, database server MySQL, dan file server Samba.  
Ketiga, saya tertarik dengan efisiensi resource yang dimiliki Ubuntu. Berbeda dengan Windows yang semakin lama semakin berat, Ubuntu bisa berjalan dengan baik bahkan di hardware yang sudah tua. Ini membuka peluang bagi saya untuk memanfaatkan komputer bekas menjadi server rumahan atau lab pembelajaran pribadi tanpa perlu investasi mahal.  
Keempat, filosofi open source yang dianut Ubuntu mengajarkan saya tentang kebebasan dan transparansi. Saya bisa melihat dan mempelajari kode sumber, memahami cara kerja sistem dari tingkat paling dasar, dan bahkan berkontribusi kembali ke komunitas. Ini adalah pengalaman yang tidak bisa saya dapatkan dari Windows yang bersifat proprietary.  
Tantangan tentu akan ada, terutama karena saya sudah terbiasa dengan GUI Windows selama 14 tahun. Saya harus beradaptasi dengan lingkungan command line yang mungkin terasa asing di awal. Namun saya percaya, dengan konsistensi belajar dan banyak praktik, saya akan semakin nyaman menggunakan Ubuntu. Rencana saya ke depan adalah menginstal Ubuntu di laptop untuk digunakan bergantian dengan Windows, sehingga saya bisa lebih sering berinteraksi dengan sistem operasi ini dalam kehidupan sehari-hari.  
Dengan demikian, mempelajari Ubuntu bukan sekadar menambah daftar skill di CV, tetapi merupakan investasi jangka panjang untuk memahami fondasi teknologi yang akan terus relevan di masa depan.   
<b>Dokumentasi</b>
![alt text](image/UBUNTU-8.png)
